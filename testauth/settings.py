...
# - absolute urls eg 'http://afatstats.com/dashboard'
...
INSTALLED_APPS += ["afatstats"]

# Register an application at https://developers.eveonline.com for Authentication
# & API Access and fill out these settings. Be sure to set the callback URL
# to https://afatstats.com/sso/callback substituting your domain for afatstats.com
...
# Set the default from email to something like 'noreply@afatstats.com'
